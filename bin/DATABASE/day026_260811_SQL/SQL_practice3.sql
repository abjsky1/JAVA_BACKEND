...
-- [문제 5]books 테이블에서 장르(genre)가 '소설' 인 도서의 price를 기존 가격에서 2000원 인상하도록 수정하세요.(산술연산자 사용)

SELECT price + 2000 from books WHERE genre = "소설";  -- 이건 조회만 하는 것
...
# select : select [*전체/속성명] from 테이블명 where 조건
SELECT * FROM books;
