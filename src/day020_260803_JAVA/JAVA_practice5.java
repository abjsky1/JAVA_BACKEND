...
public class JAVA_practice5 {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("1부터 50까지의 합계: %d", sum3);
        ...
        System.out.printf("%d 까지 더했을 때 합계가 %d로 100을 넘습니다.\n", a6 , sum6);
        ...
        */
        ...
        for(int 줄 = 1 ; 줄 <= 5 ; 줄++){
            for(int 별 = 1 ; 별 <= 줄 ; 별++){
                System.out.print("*");  // print 로 하여 줄바꿈 처리 안 함
            }
            System.out.println();
        }
        ...
        */
        ...
        for(;;){
            String aa = scan.next();
            if( aa.equals("end")) break;
            count9 += 1;
        }

        System.out.printf("[안내] 프로그램을 종료 합니다.[총 %d회 입력]", count9);
